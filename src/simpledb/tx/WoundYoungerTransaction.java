...
import simpledb.tx.concurrency.WoundYoungerConcurrencyMgr;
 ...
 */
public class WoundYoungerTransaction extends Transaction
{
	
   protected WoundYoungerConcurrencyMgr woundYoungerConcurMgr;
    ...
    * is called first.
    */
   public WoundYoungerTransaction() {
      txnum       = nextTxNumber();
      recoveryMgr = new RecoveryMgr(txnum);
      woundYoungerConcurMgr   = new WoundYoungerConcurrencyMgr();
   }
   ...
   public int getInt(Block blk, int offset) {
      woundYoungerConcurMgr.sLock(blk);
   ...
   public void setInt(Block blk, int offset, int val) {
	  woundYoungerConcurMgr.xLock(blk);
      Buffer buff = myBuffers.getBuffer(blk);
   ...
   public int size(String filename) {
      ...
      woundYoungerConcurMgr.sLock(dummyblk);
   ...
   public Block append(String filename, PageFormatter fmtr) {
      Block dummyblk = new Block(filename, END_OF_FILE);
      woundYoungerConcurMgr.xLock(dummyblk);
